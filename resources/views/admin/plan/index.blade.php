            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route($route.'create') }}" class="btn btn-success"> <i class="fa fa-plus"></i> Add
                            new</a>
      ...
      $(document).ready(function () {
        ...
        var oTable = $('#datatable1').DataTable({
          ...
          columns: [
            {data: 'id', name: 'id'},
            {data: 'days', name: 'days'},
            {data: 'plan_image', name: 'plan_image', searchable: false, orderable: false, className: 'text-center'},
            {data: 'payment_image', name: 'payment_image', searchable: false, orderable: false, className: 'text-center'},
